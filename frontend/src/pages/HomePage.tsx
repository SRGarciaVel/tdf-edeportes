      ...
      <section className="relative spray-bg py-16">
        <div className="relative z-10 flex flex-col gap-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16">
            {/* hero: texto entra desde la izquierda, mascota desde la
                derecha — la "pared" más cercana a cada uno, pedido de
                Seba (30-08-2026), inspirado en
                sf.esports.capcom.com/cpt/about (se toma la idea del
                efecto, no su código ni contenido) */}
            <RevealOnScroll
              direction="left"
      ...
      <RevealOnScroll direction="up">
        <section className="mb-12">
          ...
          {!loadingComments && recentComments.length === 0 && (
            <p className="font-mono text-xs text-tdf-muted">
              Todavía no hay comentarios en ningún perfil. Sé el primero en
              dejar uno.
            </p>
          )}
          {!loadingComments && recentComments.length > 0 && (
